...
import { Marked_Exposed_Some_APIS, MarkdownEditor } from "components/Editor";
...
export const Settings = () => {
	...
	const markdownEditorRef = React.createRef<Marked_Exposed_Some_APIS>();
	const getContentOnEditor = () => {
		const editor = markdownEditorRef.current?.getEditorInstance();
